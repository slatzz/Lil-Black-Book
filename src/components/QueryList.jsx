...
const QueryList = (props) => (
    <div className='queried-word'>
        ...
        <button id="like" onClick={() => { props.entry.thumbs_up = props.entry.thumbs_up + 1 }}>Like</button>
        <br></br>
        <span className='queried-word-thumbs-down'><b>Dislikes:   </b>{props.entry.thumbs_down}</span>
            <button id="dislike" onClick={() => props.entry.thumbs_down = props.entry.thumbs_down + 1}>Dislike</button>
            <br></br><br></br>  
